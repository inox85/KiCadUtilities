...
def parse_arguments() -> argparse.Namespace:
    ...
    parser.add_argument("--single-component", action="store_true", default=False, help="Consente di scaricare un singolo componente LCSC specificato da riga di comando")
